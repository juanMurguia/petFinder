...
export class MascotaReportada extends HTMLElement {
  connectedCallback() {
    this.render();
  }
  render() {
    ...
    this.innerHTML = `
          ...
          <div class="contenedor-main">
              <div class="contenedor-title">
                  <mi-texto tipoTexto="subtitle">Mascota reportada ✅ ✅ ✅</mi-texto>
              </div>
...
customElements.define("mascota-reportada", MascotaReportada);
