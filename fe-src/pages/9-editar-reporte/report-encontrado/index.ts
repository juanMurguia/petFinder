...
export class PetEncontrado extends HTMLElement {
  connectedCallback() {
    this.render();
  }
  render() {
    ...
    this.innerHTML = `
          ...
          <div class="contenedor-main">
              <div class="contenedor-title">
                  <mi-texto tipoTexto="subtitle">Reportaste como encontrado ✅ ✅ ✅</mi-texto>
              </div>
...
customElements.define("mascota-encontrada", PetEncontrado);
